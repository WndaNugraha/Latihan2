            ...
            <div class="card-body">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <div class="row">
                            <div class="col=3">
                            <a href="show.php?id=<?php echo $data['no']; ?>" class="btn btn-warning">Show</a> ||
                            </div>
                            <div class="col=3">
                            <a href="edit.php?id=<?php echo $data['no']; ?>" class="btn btn-success">Edit</a> ||
                            </div>
                            <div class="col=3">
